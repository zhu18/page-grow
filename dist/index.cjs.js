...
var RuleFactory = /** @class */ (function () {
    ...
    RuleFactory.create = function (opt) {
        var rule;
        switch (opt.growType) {
            case exports.EGrowType.LeftTopToRightBottom:
            ...
            case exports.EGrowType.LeftToRight:
                ...
                break;
            case exports.EGrowType.CenterToAround:
...
var HTMLGrowAnimateController = /** @class */ (function () {
    ...
    Object.defineProperty(HTMLGrowAnimateController.prototype, "effects", {
        get: function () {
            var effects = Object.keys(gsap.gsap.effects);
            return effects;
        },
        enumerable: false,
        configurable: true
    ...
    HTMLGrowAnimateController.prototype.creatTl = function () {
        gsap.gsap.registerPlugin(ScrambleTextPlugin);
            ...
            gsap.gsap.registerEffect({
                ...
                effect: function (targets, config) {
                    if (effect.animate === 'from') {
                        return gsap.gsap.from(targets, __assign(__assign({}, effect.props), config));
                    }
                    else if (effect.animate === 'fromTo') {
                        return gsap.gsap.fromTo(targets, __assign(__assign({}, effect.props), config), __assign({}, effect.props2));
                    }
                    else {
                        return gsap.gsap.to(targets, __assign(__assign({}, effect.props), config));
                    }
                }
            });
        });
    ...
    HTMLGrowAnimateController.prototype._setElementAnimate = function (element) {
        ...
        switch (element.type) {
            case EGrowElementType.chart:
                ...
                gt = gsap.gsap.effects.sys_opacity(element.el, { duration: EGrowElementTime.chart });
                break;
            case EGrowElementType.bg:
                gt = gsap.gsap.effects[this._option.bgType](element.el, { duration: EGrowElementTime.bg });
            ...
            case EGrowElementType.image:
                gt = gsap.gsap.effects[this._option.imageType](element.el, { duration: EGrowElementTime.image, originalStyle: element.originalStyle });
                break;
            case EGrowElementType.svg:
                gt = gsap.gsap.effects[this._option.svgType](element.el, { duration: EGrowElementTime.svg });
                break;
            case EGrowElementType.canvas:
                gt = gsap.gsap.effects[this._option.canvasType](element.el, { duration: EGrowElementTime.svg });
                break;
            case EGrowElementType.video:
                gt = gsap.gsap.effects[this._option.videoType](element.el, { duration: EGrowElementTime.video });
                break;
            case EGrowElementType.string:
                gt = gsap.gsap.effects[this._option.stringType](element.el, { duration: EGrowElementTime.string });
                break;
            case EGrowElementType.number:
                gt = gsap.gsap.effects[this._option.numberType](element.el, { duration: EGrowElementTime.number, value: element.el.innerHTML });
                break;
            case EGrowElementType.bgNumber:
                gt = gsap.gsap.effects.sys_bgNumber(element.el, { duration: EGrowElementTime.bgNumber, value: element.el.innerHTML });
                break;
            case EGrowElementType.bgString:
                gt = gsap.gsap.effects.sys_opacity(element.el, { duration: EGrowElementTime.bgString, value: element.el.innerHTML });
                break;
            case EGrowElementType.leafNode:
                // gt=gsap.effects[this._option.leafNodeType](element.el, {duration: EGrowElementTime.string})
                gt = gsap.gsap.effects[this._option.leafNodeType](element.el, { duration: EGrowElementTime.bg, originalStyle: element.originalStyle });
                break;
    ...
    HTMLGrowAnimateController.prototype._registerEffects = function () {
        ...
        gsap.gsap.registerEffect({
            name: 'sys_opacity',
            effect: function (targets, config) {
                return gsap.gsap.fromTo(targets, { opacity: 0 }, { opacity: 1, duration: config.duration });
            },
        });
        //缩放
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                return gsap.gsap.fromTo(targets, { opacity: 0, scale: 0 }, { opacity: 1, scale: 1, transformOrigin: _this._getTransformOrigin(), duration: config.duration });
            },
        });
        //高度变化
        gsap.gsap.registerEffect({
            name: 'sys_height',
            effect: function (targets, config) {
                return gsap.gsap.fromTo(targets, { opacity: 0, height: 0 }, { opacity: 1, height: config.originalStyle.height, duration: config.duration });
            },
        });
        //宽度变化
        gsap.gsap.registerEffect({
            name: 'sys_width',
            effect: function (targets, config) {
                return gsap.gsap.fromTo(targets, { opacity: 0, width: 0 }, { opacity: 1, width: config.originalStyle.width, duration: config.duration });
            },
        });
        //数字
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                return gsap.gsap.to(targets, { opacity: 1, duration: 0.1, onComplete: function () {
                        gsap.gsap.to(count, { duration: config.duration, val: actualValue, onUpdate: function () {
                                if (hasThousander) {
        ...
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                gsap.gsap.set(targets, { opacity: 1, perspective: 400 });
                return gsap.gsap.from(chars, { duration: duration, opacity: 0, scale: 0, y: 80, rotationX: 100, transformOrigin: "0% 50% -50", ease: "back", stagger: 0.01 });
            },
        });
        //stringPrint
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                return gsap.gsap.to(targets, { duration: duration, scrambleText: __assign({}, opt) });
            },
        });
        ...
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                targets[0].innerHTML = "";
                return gsap.gsap.fromTo(targets, { opacity: 0 }, { opacity: 1, duration: config.duration, onComplete: function () {
                        targets[0].innerHTML = text;
                        var mySplitText = new SplitText(targets, { type: "chars" });
                        var chars = mySplitText.chars;
                        gsap.gsap.set(targets, { perspective: 400 });
                        gsap.gsap.from(chars, { duration: config.duration, opacity: 0, scale: 0, y: 80, rotationX: 100, transformOrigin: '0 50% -50', ease: "back", stagger: 0.01 });
                    } });
            },
        });
        //bgNumber
        gsap.gsap.registerEffect({
            ...
            effect: function (targets, config) {
                ...
                return gsap.gsap.fromTo(targets, { opacity: 0 }, { duration: config.duration, opacity: 1, onComplete: function () {
                        var count = { val: 0 };
                        gsap.gsap.to(count, { duration: config.duration, val: actualValue, onUpdate: function () {
                                if (hasThousander) {
                                    targets[0].innerHTML = fomatterNum(Number(count.val.toFixed(decimals)));
...
Object.defineProperty(exports, 'gsap', {
	enumerable: true,
	get: function () { return gsap.gsap; }
});
exports.AbstractParser = AbstractParser;
exports.CenterToAroundParserRule = CenterToAroundParserRule;
exports.HTMLPageParser = HTMLPageParser;
exports.LeftToRightParserRule = LeftToRightParserRule;
exports.LeftTopToRightBottomParserRule = LeftTopToRightBottomParserRule;
exports.PageGrow = PageGrow;
exports.RuleFactory = RuleFactory;
exports.TopToBottomParserRule = TopToBottomParserRule;
