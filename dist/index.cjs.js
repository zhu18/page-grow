...
var HTMLPageParser = /** @class */ (function (_super) {
     ...
     * @param y y位置
     */
    HTMLPageParser.prototype._parseHTMLElement = function (element, x, y) {
        var _a, _b, _c, _d;
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        x += element.offsetLeft - ((_b = (_a = element.offsetParent) === null || _a === void 0 ? void 0 : _a.clientLeft) !== null && _b !== void 0 ? _b : 0);
        y += element.offsetTop - ((_d = (_c = element.offsetParent) === null || _c === void 0 ? void 0 : _c.clientTop) !== null && _d !== void 0 ? _d : 0);
...
var TopToBottomParserRule = /** @class */ (function () {
    ...
    TopToBottomParserRule.prototype.exec = function (elements) {
        //TopToBottom 进场排序
        var ele = getOrderTopToBottom(elements);
...
var LeftToRightParserRule = /** @class */ (function () {
    ...
    LeftToRightParserRule.prototype.exec = function (elements) {
        //LeftToRight 进场排序
        var ele = getOrderLeftToRight(elements);
 ...
 * @returns
 */
function setTopToBottomTime(elements, parentEle) {
    for (var i = 0; i < elements.length; i++) {
 ...
 * @returns
 */
function setLeftToRightTime(elements, parentEle) {
    for (var i = 0; i < elements.length; i++) {
        for (var j = 0; j < elements[i].length; j++) {
            if (parentEle) {
